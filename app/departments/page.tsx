...
const departments = [
  ...
  },
  {
    ...
    description: "Excellence in hotel and tourism industry management",
    icon: "🏨",
  ...
  },
  {
    ...
    description: "Modern marketing strategies for the digital economy",
    icon: "📱",
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-primary-foreground/90 max-w-2xl mx-auto">
                Explore our comprehensive range of government-certified diploma programs designed to prepare you for
                career success
              </p>
            </div>
          </div>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="font-serif text-3xl md:text-4xl font-bold text-primary mb-4">Featured Programs</h2>
        ...
        <section className="py-20 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="font-serif text-3xl md:text-4xl font-bold text-primary mb-4">All Programs</h2>
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="bg-primary text-primary-foreground rounded-2xl p-8 md:p-12 text-center">
              <h2 className="font-serif text-3xl md:text-4xl font-bold mb-4">Ready to Choose Your Path?</h2>
