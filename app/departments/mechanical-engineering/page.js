          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h1 className="font-serif text-4xl md:text-5xl font-bold mb-2">Mechanical Engineering</h1>
              ...
              <div className="lg:col-span-2">
                ...
                <div className="prose prose-lg max-w-none">
                  <p className="text-muted-foreground mb-6">
                    Our Mechanical Engineering diploma program is designed to provide students with comprehensive knowledge
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm">cs@wii.edu</span>
                    </div>
                    <div className="flex items-center gap-3">
