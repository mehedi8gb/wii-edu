                    ...
                    <div className="container mx-auto px-4">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                                Join one of our many student organizations and make lasting connections while developing
                                leadership
                                skills
                            </p>
                        </div>
                                                ...
                                                <Card key={activity.id}
                                                    ...
                                                    <CardContent className="space-y-3">
                                                        <div
                                                            ...
                                                            Registration: {activity.registration} <br />
                                                            Roll: {activity.roll}
                                                        </div>
                            ...
                            {achievements.map((achievement, index) => (
                                <Card key={index} className="hover:shadow-lg transition-shadow duration-300">
                                    <CardHeader>
                                        <div className="flex items-center justify-between mb-2">
                                            <Badge
                                                className="bg-accent text-accent-foreground">{achievement.award}</Badge>
                                        ...
                                        <CardDescription
                                            className="text-primary font-medium">{achievement.winner}</CardDescription>
                                    </CardHeader>
                                    <CardContent>
